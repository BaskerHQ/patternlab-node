...
## [7.0.1](https://github.com/BaskerHQ/patternlab-node/compare/v7.0.0...v7.0.1) (2024-10-21)

**Note:** Version bump only for package @baskerhq/uikit-polyfills
...
* update package.json description in `@pattern-lab/uikit-polyfills` ([22fc44a](https://github.com/BaskerHQ/patternlab-node/commit/22fc44a4b3683753a469a98abfcdad8f1234f28a))


### Features

* major refactoring + UI updates to address cross browser support; UI cleanup and conversion of the majority of the remaining components over to lit-element ([2ff8e1c](https://github.com/BaskerHQ/patternlab-node/commit/2ff8e1c98cdd02e8077064c48eca5f7754a3db02))
...
**Note:** Version bump only for package @pattern-lab/uikit-polyfills
